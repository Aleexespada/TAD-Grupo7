<nav class="sticky-top flex-shrink-0 py-4 bg-black min-vh-100">
    <a href="{{ route('dashboard') }}" class="d-flex align-items-center px-3 px-md-4 pb-3 mb-3 link-body-emphasis text-decoration-none border-bottom">
    ...
    <div class="list-group mt-4 rounded-0">
        <a href="{{ route('dashboard') }}" class="list-group-item list-group-item-action border-0 bg-black @if(Request::path() == 'admin') text-light @else text-muted @endif" aria-current="true">
